<script lang="ts">
  // Simple dashboard example with clean styling
      ...
      <section class="section">
        ...
        <div class="card-grid">
          ...
          <div class="card">
            ...
            <div class="card-content">
              <div class="value">{batteryLevel.toFixed(0)}<span class="unit">%</span></div>
              <div class="progress-bar">
                <div class="progress-fill" style="width: {batteryLevel}%; background-color: {batteryLevel > 50 ? '#10b981' : '#f59e0b'};"></div>
              </div>
              <p class="progress-text">{batteryLevel > 80 ? 'Fully charged' : batteryLevel > 30 ? 'Optimal level' : 'Low charge'}</p>
            </div>
          </div>
          ...
          <div class="card">
            ...
            <div class="card-content">
              <div class="value">{tokenBalance.toFixed(0)} <span class="unit">tokens</span></div>
              <div class="token-info">
                <div>
                  <span class="label">Value:</span>
                  <span class="value-small">₱{(tokenBalance * 0.5).toFixed(2)}</span>
                </div>
                <div>
                  <span class="label">Last earned:</span>
                  <span class="value-small">10 min ago</span>
                </div>
              </div>
            </div>
          </div>
